...
const Pin = ({ image, postedBy, _id, destination, save }) => {
  ...
  /*
    !! will be used to convert it into a boolean
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user?.id && (
                <button
                  ...
                  className="bg-white p-2 text-base font-bold text-dark rounded-3xl opacity-70 hover:opacity-100 hover:shadow-md outline-none">
                  <AiTwotoneDelete />
                </button>
              )}
            </div>
